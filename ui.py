...
class AppUI(QMainWindow):
    ...
    def welcome_tab(self):
        ...
        self.project_name_lbl.setGeometry(QRect(140, 115, 251, 191))
        self.project_name_lbl.setFont(font1)
        ...
        self.project_decription_lbl.setGeometry(QRect(80, 300, 364, 91))
        self.project_decription_lbl.setFont(font2)
    ...
    def main_tab(self):
        ...
        self.layoutWidget.setGeometry(QRect(75, 90, 385, 220))
